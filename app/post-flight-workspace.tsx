...
export function PostFlightWorkspace({ model, mode, workspaceVersion, headers, canImport, canDelete, theme, accent, guidedPlayback = false, onNotice }: Props) {
