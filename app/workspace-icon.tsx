type IconName = "configuration" | "simulation" | "postflight" | "history" | "tests" | "documents" | "checklists" | "settings";
...
export function WorkspaceIcon({ name }: { name: IconName }) {
  ...
  return <svg className="workspace-icon" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {name === "postflight" && <><circle {...common} cx="12" cy="12" r="8.5" /><path {...common} d="M3.8 12h16.4M12 3.5c2.1 2.2 3.2 5 3.2 8.5S14.1 18.3 12 20.5M12 3.5c-2.1 2.2-3.2 5-3.2 8.5" /><path {...common} d="m8 14 2.2-3 2.2 1.3 3.2-4.1" /></>}
